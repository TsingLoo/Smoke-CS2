...
layout(set = 1, binding = 1, std140) uniform _633_4459
{
...
layout(set = 1, binding = 5, scalar) uniform _754_4023
{
...
layout(set = 1, binding = 0, std140) uniform _2920_5618
{
...
layout(set = 1, binding = 4, std140) uniform _1030_5037
{
...
layout(set = 3, binding = 0, std140) uniform _1080_5538
{
...
void main()
{
    ...
    vec3 _8251 = _23296 * (_4023._m6.xyz - _4459._m2);
    vec3 _6243 = _23296 * (_4023._m7.xyz - _4459._m2);
    ...
    float _3914 = _5618._m17 * 1.5;
    ivec2 _19617 = ivec2(gl_FragCoord.xy);
    float _25102 = max(_12676, 4.0) + (((_3914 * fract(texelFetch(_5975, ivec3(_19617 & _5037._m0, 0).xy, 0).x + (_4459._m7 * 0.61803400516510009765625))) * _5618._m0) * mix(0.100000001490116119384765625, 0.800000011920928955078125, clamp((_12676 + 150.0) * 0.0500000007450580596923828125, 0.0, 1.0)));
    ivec2 _17338 = ivec3(_19617, 0).xy;
    float _10955 = _4459._m5 - _4459._m3;
    float _24159 = (clamp((texelFetch(_4543, _17338, 0).x - _4459._m3) / _10955, 0.0, 1.0) * _4459._m1.z) + _4459._m1.w;
    float _15694 = dot(_4459._m4.xyz, _15861);
    float _19245 = 1.0 / (_24159 * _15694);
    vec3 _18051 = (-_15861).xyz;
    vec3 _7391 = _4459._m2.xyz + (_18051 * (1.0 / (_24159 * dot(_4459._m4.xyz, _18051))));
    bool _6681 = _4023._m15 > 0u;
    bool _12666;
    if (_6681)
    {
        _12666 = ((1.0 / (((clamp((texelFetch(_5967, ivec3(ivec2(gl_FragCoord.xy * float(_5618._m24)), 0).xy, 0).x - _4459._m3) / _10955, 0.0, 1.0) * _4459._m1.z) + _4459._m1.w) * _15694)) - _19245) > 10.0;
    }
    else
    {
        _12666 = false;
    ...
    vec3 _5607 = _4459._m2 + (_15861 * _25102);
    vec3 _4987 = _4459._m2 + (_15861 * min(_14150, _4364));
    ...
    for (;;)
    {
        ...
        if ((_17017 & 1u) != 0u)
        {
            vec3 _8252 = _23296 * (_4023._m0._m0[_13136].xyz - _4459._m2);
            vec3 _6244 = _23296 * (_4023._m1._m0[_13136].xyz - _4459._m2);
    ...
    do
    {
        ...
        vec3 _19298 = cross(_4459._m4, _4459._m6);
            ...
            for (;;)
            {
                ...
                do
                {
                    ...
                    do
                    {
                        ...
                        for (;;)
                        {
                            if (!(_17020 < min(_4023._m13, 16u)))
                            {
                                break;
                            }
                            vec3 _21554 = _4023._m9._m0[_17020].xyz - _4023._m8._m0[_17020].xyz;
                            vec3 _14636 = _17120 - _4023._m8._m0[_17020].xyz;
                            float _19448 = clamp((length(_14636 - (_21554 * clamp(dot(_14636, _21554) / dot(_21554, _21554), 0.0, 1.0))) * 0.0500000007450580596923828125) * _4023._m10._m0[_17020].x, 0.0, 1.0);
                            float _14626 = smoothstep(0.0, 0.00999999977648258209228515625, _4023._m8._m0[_17020].w) * (1.0 - smoothstep(0.00999999977648258209228515625, 0.20000000298023223876953125, _4023._m8._m0[_17020].w));
                            float _6223;
                            if (_19448 < 1.0)
                            {
                                float _18731 = max(_17135, smoothstep(0.0, 1.0, 1.0 - clamp(_4023._m8._m0[_17020].w + clamp(_19448 + (1.0 - clamp(length(_17120 - _4023._m9._m0[_17020].xyz) * 0.00999999977648258209228515625, 0.0, 1.0)), 0.0, 1.0), 0.0, 1.0)));
                                _13140 = mix(_16307, normalize(_4023._m8._m0[_17020].xyz - _4023._m9._m0[_17020].xyz), vec3(_18731));
                                _13189 = _18731;
                    ...
                    do
                    {
                        ...
                        vec3 _14658 = clamp((((_25170 - _4023._m2._m0[_22666].xyz) * vec3(0.0500000007450580596923828125)) + vec3(16.0)) * vec3(0.03125), vec3(0.0), vec3(1.0));
                        vec3 _21495 = clamp(_14658, vec3(0.0), vec3(1.0));
                        uint _14092 = uint(_4023._m3._m0[_25081].z);
                        ...
                        vec2 _7714 = mix(_11487.xz, _11487.yw, vec2(_4023._m3._m0[_25081].y));
                        ...
                        {
                            float _17820 = max(0.0, _8283 - min(20.0, abs(_7391.z - _4023._m2._m0[_22666].z) * 2.0));
                            float _20845 = clamp(clamp((_6665 - 0.00999999977648258209228515625) * 1.01010096073150634765625, 0.0, 1.0), 0.0, 1.0) * _4023._m5._m0[_25081].x;
                            float _22281 = clamp(_20845 + ((1.0 - clamp(distance(_4459._m2, _25170) * 0.100000001490116119384765625, 0.0, 1.0)) * _20845), 0.0, 1.0);
                            vec3 _6616;
                            float _13148;
                            float _13694;
                            float _16310;
                            if (_6681)
                            {
                                ...
                                for (;;)
                                {
                                    ...
                                    do
                                    {
                                        if (!(_17021 < min(_4023._m15, 5u)))
                                        {
                                            _7957_ladder_break = true;
                                            break;
                                        }
                                        if ((uint(_4023._m12._m0[_17021 >> uint(2)][_17021 & 3u]) & (1u << _14092)) == 0u)
                                        {
                                            _13147 = _13142;
                                            _14082 = _17136;
                                            _18360 = _16309;
                                        ...
                                        float _10810 = _4023._m14 - _4023._m11._m0[_17021].w;
                                        vec3 _13146;
                                        float _16382;
                                        float _16480;
                                        if (_10810 < (_4023._m3._m0[_25081].x - 0.4000000059604644775390625))
                                        {
                                            float _13668 = distance(_13142, _4023._m11._m0[_17021].xyz);
                                            vec3 _13143;
                                            float _16381;
                                            float _16479;
                                            if (_13668 < 250.0)
                                            {
                                                ...
                                                _13143 = mix(_13142, _4023._m11._m0[_17021].xyz, vec3(((1.0 - smoothstep(100.0, 250.0, _13668)) * step(_10810 * 1250.0, _13668)) * (1.0 - _16611)));
                            ...
                            float _20017 = _4459._m7 * _5618._m2;
                            ...
                            float _20360 = 0.800000011920928955078125 / _5618._m8;
                            ...
                            mat4 _21989 = mat4(vec4(_4459._m0._m0[0].x, _4459._m0._m0[1].x, _4459._m0._m0[2].x, _4459._m0._m0[3].x), vec4(_4459._m0._m0[0].y, _4459._m0._m0[1].y, _4459._m0._m0[2].y, _4459._m0._m0[3].y), vec4(_4459._m0._m0[0].z, _4459._m0._m0[1].z, _4459._m0._m0[2].z, _4459._m0._m0[3].z), vec4(_4459._m0._m0[0].w, _4459._m0._m0[1].w, _4459._m0._m0[2].w, _4459._m0._m0[3].w));
                            float _16360 = _11675.z;
                            vec3 _20799 = (_11772 + ((((_21989 * vec4((_6512 + vec3(0.0, 0.0, 1.0)).xyz, 0.0)).xyz * pow(_11087, 0.100000001490116119384765625)) * _5618._m18) * 0.20000000298023223876953125)) + (vec3(2.0, 2.0, 4.5) * ((((_11087 - 1.0) * 0.20000000298023223876953125) * _5618._m18) * _16360));
                            _20799.x = _20799.x + (sin(_8650 + (_20017 * 0.25)) * 0.0500000007450580596923828125);
                            vec3 _19464 = _20799 * _5618._m9;
                            ...
                            float _17671 = _5618._m4 * (dot(_15861, _4459._m4) * clamp(distance(_6616, _4459._m2) * 0.004999999888241291046142578125, 0.0, 1.0));
                            float _13150 = (mix(0.949999988079071044921875, clamp(_11087, 0.0, 1.0), _5618._m3) + mix(0.949999988079071044921875, clamp(_11089, 0.0, 1.0), _17671 * 0.25)) + _5618._m7;
                            float _11621;
                            if (_4023._m5._m0[_25081].w < 1.0)
                            {
                                float _14675 = clamp(_4023._m5._m0[_25081].w, 9.9999997473787516355514526367188e-05, 0.99989998340606689453125);
                            ...
                            float _13439 = mix(_11621 - (1.0 - _13150), _11621 + _13150, _11621) * clamp((_4023._m5._m0[_25081].x * _4023._m5._m0[_25081].w) * 8.0, 0.0, 1.0);
                            ...
                            vec4 _13055 = _21989 * vec4(((vec4(_21940.xyz, 0.0).xyzw * _21989).xyz + ((vec3((_6512.xy * _5618._m3) + ((normalize(vec3(_11089 - ((_19781.x + (_19781.y * 0.949999988079071044921875)) * 4.599999904632568359375), _11089 - ((_19780.x + (_19780.y * 0.949999988079071044921875)) * 4.599999904632568359375), _20360)) * mix(0.5, 1.0, clamp(_11087 - 0.5, 0.0, 1.0))).xy * (_17671 * 1.5)), 0.0) * _5618._m5) * mix(1.0, 2.0, clamp((200.0 - distance(_6616, _4023._m2._m0[_22666].xyz)) * 0.004999999888241291046142578125, 0.0, 1.0)))).xyz, 0.0);
                            ...
                            vec3 _24091 = (((((((normalize(_14327 + vec3(0.001000000047497451305389404296875)) * min(length(_14327), 4.0)) * clamp(1.0 - min(0.25, _13439), 0.0, 1.0)) * clamp(1.0 - (((_11621 * 2.400000095367431640625) - _13439) * _5618._m16), 0.0, 1.0)) * _13150) * (0.75 + (_11275 * 0.25))) * (1.0 + (_13055.z * 0.5))) * _5618._m13) + ((_5538._m1.xyz * ((0.5 * _11275) * (1.0 - _13618))) * _5618._m14);
                            vec3 _23772 = _24091 * _4023._m4._m0[_25081].xyz;
                            vec3 _16436 = (mix(_24091, _23772 * (dot(_24091.xyz, vec3(0.2125000059604644775390625, 0.7153999805450439453125, 0.07209999859333038330078125)) / dot((_23772 + vec3(0.001000000047497451305389404296875)).xyz, vec3(0.2125000059604644775390625, 0.7153999805450439453125, 0.07209999859333038330078125))), vec3(0.5 * (1.0 - _4023._m5._m0[_25081].z))) * mix(vec3(1.0), normalize(_5618._m20 + vec3(0.00999999977648258209228515625)) * 1.73199999332427978515625, vec3(clamp(0.5 + (_13439 * 6.0), 0.0, 1.0)))).xyz;
                            vec3 _21313 = mix(_16436, _16436 * _13148, vec3(0.60000002384185791015625)).xyz;
                            float _22660 = smoothstep(0.0, 0.20000000298023223876953125, _13439 + 0.300000011920928955078125) * (((clamp((_5618._m22 - _17820) / _5618._m22, 0.0, 1.0) * _11621) * 6.0) * _5618._m21);
                            float _17656 = smoothstep(0.0, 0.20000000298023223876953125 / (_5618._m1 * mix(0.5, 2.0, _17126.w)), _13439);
            ...
            for (;;)
            {
                ...
                do
                {
                    ...
                    do
                    {
                        ...
                        for (;;)
                        {
                            if (!(_17024 < min(_4023._m13, 16u)))
                            {
                                break;
                            }
                            vec3 _21555 = _4023._m9._m0[_17024].xyz - _4023._m8._m0[_17024].xyz;
                            vec3 _14637 = _21812 - _4023._m8._m0[_17024].xyz;
                            float _19449 = clamp((length(_14637 - (_21555 * clamp(dot(_14637, _21555) / dot(_21555, _21555), 0.0, 1.0))) * 0.0500000007450580596923828125) * _4023._m10._m0[_17024].x, 0.0, 1.0);
                            float _14627 = smoothstep(0.0, 0.00999999977648258209228515625, _4023._m8._m0[_17024].w) * (1.0 - smoothstep(0.00999999977648258209228515625, 0.20000000298023223876953125, _4023._m8._m0[_17024].w));
                            float _6224;
                            if (_19449 < 1.0)
                            {
                                float _18732 = max(_17170, smoothstep(0.0, 1.0, 1.0 - clamp(_4023._m8._m0[_17024].w + clamp(_19449 + (1.0 - clamp(length(_21812 - _4023._m9._m0[_17024].xyz) * 0.00999999977648258209228515625, 0.0, 1.0)), 0.0, 1.0), 0.0, 1.0)));
                                _13159 = mix(_16317, normalize(_4023._m8._m0[_17024].xyz - _4023._m9._m0[_17024].xyz), vec3(_18732));
                                _13190 = _18732;
                    ...
                    do
                    {
                        ...
                        vec3 _14659 = clamp((((_25172 - _4023._m2._m0[_22667].xyz) * vec3(0.0500000007450580596923828125)) + vec3(16.0)) * vec3(0.03125), vec3(0.0), vec3(1.0));
                        vec3 _21496 = clamp(_14659, vec3(0.0), vec3(1.0));
                        uint _14093 = uint(_4023._m3._m0[_25082].z);
                        ...
                        vec2 _7715 = mix(_11488.xz, _11488.yw, vec2(_4023._m3._m0[_25082].y));
                        ...
                        {
                            float _17821 = max(0.0, _8284 - min(20.0, abs(_7391.z - _4023._m2._m0[_22667].z) * 2.0));
                            float _20846 = clamp(clamp((_6666 - 0.00999999977648258209228515625) * 1.01010096073150634765625, 0.0, 1.0), 0.0, 1.0) * _4023._m5._m0[_25082].x;
                            float _22282 = clamp(_20846 + ((1.0 - clamp(distance(_4459._m2, _25172) * 0.100000001490116119384765625, 0.0, 1.0)) * _20846), 0.0, 1.0);
                            vec3 _6617;
                            float _13166;
                            float _13695;
                            float _16320;
                            if (_6681)
                            {
                                ...
                                for (;;)
                                {
                                    ...
                                    do
                                    {
                                        if (!(_17025 < min(_4023._m15, 5u)))
                                        {
                                            _7959_ladder_break = true;
                                            break;
                                        }
                                        if ((uint(_4023._m12._m0[_17025 >> uint(2)][_17025 & 3u]) & (1u << _14093)) == 0u)
                                        {
                                            _13165 = _13162;
                                            _14084 = _17173;
                                            _18362 = _16319;
                                        ...
                                        float _10811 = _4023._m14 - _4023._m11._m0[_17025].w;
                                        vec3 _13164;
                                        float _16384;
                                        float _16482;
                                        if (_10811 < (_4023._m3._m0[_25082].x - 0.4000000059604644775390625))
                                        {
                                            float _13669 = distance(_13162, _4023._m11._m0[_17025].xyz);
                                            vec3 _13163;
                                            float _16383;
                                            float _16481;
                                            if (_13669 < 250.0)
                                            {
                                                ...
                                                _13163 = mix(_13162, _4023._m11._m0[_17025].xyz, vec3(((1.0 - smoothstep(100.0, 250.0, _13669)) * step(_10811 * 1250.0, _13669)) * (1.0 - _16614)));
                            ...
                            float _20018 = _4459._m7 * _5618._m2;
                            ...
                            float _20361 = 0.800000011920928955078125 / _5618._m8;
                            ...
                            mat4 _21990 = mat4(vec4(_4459._m0._m0[0].x, _4459._m0._m0[1].x, _4459._m0._m0[2].x, _4459._m0._m0[3].x), vec4(_4459._m0._m0[0].y, _4459._m0._m0[1].y, _4459._m0._m0[2].y, _4459._m0._m0[3].y), vec4(_4459._m0._m0[0].z, _4459._m0._m0[1].z, _4459._m0._m0[2].z, _4459._m0._m0[3].z), vec4(_4459._m0._m0[0].w, _4459._m0._m0[1].w, _4459._m0._m0[2].w, _4459._m0._m0[3].w));
                            float _16361 = _11676.z;
                            vec3 _20801 = (_11773 + ((((_21990 * vec4((_6513 + vec3(0.0, 0.0, 1.0)).xyz, 0.0)).xyz * pow(_11091, 0.100000001490116119384765625)) * _5618._m18) * 0.20000000298023223876953125)) + (vec3(2.0, 2.0, 4.5) * ((((_11091 - 1.0) * 0.20000000298023223876953125) * _5618._m18) * _16361));
                            _20801.x = _20801.x + (sin(_8651 + (_20018 * 0.25)) * 0.0500000007450580596923828125);
                            vec3 _19465 = _20801 * _5618._m9;
                            ...
                            float _17672 = _5618._m4 * (dot(_15861, _4459._m4) * clamp(distance(_6617, _4459._m2) * 0.004999999888241291046142578125, 0.0, 1.0));
                            float _13168 = (mix(0.949999988079071044921875, clamp(_11091, 0.0, 1.0), _5618._m3) + mix(0.949999988079071044921875, clamp(_11093, 0.0, 1.0), _17672 * 0.25)) + _5618._m7;
                            float _11622;
                            if (_4023._m5._m0[_25082].w < 1.0)
                            {
                                float _14676 = clamp(_4023._m5._m0[_25082].w, 9.9999997473787516355514526367188e-05, 0.99989998340606689453125);
                            ...
                            float _13440 = mix(_11622 - (1.0 - _13168), _11622 + _13168, _11622) * clamp((_4023._m5._m0[_25082].x * _4023._m5._m0[_25082].w) * 8.0, 0.0, 1.0);
                            ...
                            vec4 _13056 = _21990 * vec4(((vec4(_21941.xyz, 0.0).xyzw * _21990).xyz + ((vec3((_6513.xy * _5618._m3) + ((normalize(vec3(_11093 - ((_19786.x + (_19786.y * 0.949999988079071044921875)) * 4.599999904632568359375), _11093 - ((_19785.x + (_19785.y * 0.949999988079071044921875)) * 4.599999904632568359375), _20361)) * mix(0.5, 1.0, clamp(_11091 - 0.5, 0.0, 1.0))).xy * (_17672 * 1.5)), 0.0) * _5618._m5) * mix(1.0, 2.0, clamp((200.0 - distance(_6617, _4023._m2._m0[_22667].xyz)) * 0.004999999888241291046142578125, 0.0, 1.0)))).xyz, 0.0);
                            ...
                            float _15562 = dot(mix(_21941, _19633, vec3(_5618._m6)), _5538._m0.xyz);
                            ...
                            vec3 _24094 = (((((((normalize(_14328 + vec3(0.001000000047497451305389404296875)) * min(length(_14328), 4.0)) * clamp(1.0 - min(0.25, _13440), 0.0, 1.0)) * clamp(1.0 - (((_11622 * 2.400000095367431640625) - _13440) * _5618._m16), 0.0, 1.0)) * _13168) * (0.75 + (_11276 * 0.25))) * (1.0 + (_13056.z * 0.5))) * _5618._m13) + ((_5538._m1.xyz * ((0.5 * _11276) * (1.0 - _13620))) * _5618._m14);
                            vec3 _23773 = _24094 * _4023._m4._m0[_25082].xyz;
                            ...
                            float _22661 = smoothstep(0.0, 0.20000000298023223876953125, _13440 + 0.300000011920928955078125) * (((clamp((_5618._m22 - _17821) / _5618._m22, 0.0, 1.0) * _11622) * 6.0) * _5618._m21);
                            float _17657 = smoothstep(0.0, 0.20000000298023223876953125 / (_5618._m1 * mix(0.5, 2.0, _17163.w)), _13440);
    ...
    float _23125 = pow(clamp(dot(normalize(_15861), _5538._m0.xyz), 0.0, 1.0), 4.0) * 0.25;
    float _19877 = clamp(_12756 - (_14229.w * 0.20000000298023223876953125), 0.0, 1.0);
    vec4 _19214 = mix(vec4(_14229.xyz * mix(1.0, 0.0, _19877), _14229.w + _19877), _14229, bvec4(_5618._m21 == 0.0));
    vec3 _22768 = _19214.xyz * (vec3(1.0) + ((pow(_5538._m1.xyz, vec3(2.0)) * (((_23125 + (pow(_23125, 50.0) * 8.0)) * mix(1.0, 0.0, pow(_14229.w, 0.5))) * _14229.w)) * (_17192 * _5618._m15)));
    vec4 _23714 = _19214;
    _23714.x = _22768.x;
    _23714.y = _22768.y;
    _23714.z = _22768.z;
    ...
    float _13311 = _5037._m2 - _5037._m1;
    float _9068 = (((log(dot(_4459._m4.xyz, _16327.xyz - _4459._m2.xyz)) - _5037._m1) / _13311) * 2.0) - 1.0;
    float _11137 = (((log(dot(_4459._m4.xyz, _13175.xyz - _4459._m2.xyz)) - _5037._m1) / _13311) * 2.0) - 1.0;
    vec4 _13176;
    vec4 _16328;
    vec4 _17193;
    _13176 = vec4(0.0);
